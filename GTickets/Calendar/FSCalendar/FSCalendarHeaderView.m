...
- (void)layoutSubviews
{
    ...
    self.toPrevMonth.frame = CGRectMake(0, 0, BUTTONS_WIDTH, self.frame.size.height);
    self.toNextMonth.frame = CGRectMake(self.frame.size.width - BUTTONS_WIDTH, 0, BUTTONS_WIDTH, self.frame.size.height);
