...
//custom
#define FONTNAME @"FuturaPT-Medium"

#define FONTS_COEFICIENT 414 * [UIScreen mainScreen].bounds.size.width    //20/414*375
...
- (instancetype)init
{
    self = [super init];
    if (self) {
        _titleFont = [UIFont fontWithName:FONTNAME size:FSCalendarStandardTitleTextSize/FONTS_COEFICIENT];
        _subtitleFont = [UIFont fontWithName:FONTNAME size:FSCalendarStandardSubtitleTextSize/FONTS_COEFICIENT];
        _weekdayFont = [UIFont fontWithName:FONTNAME size:FSCalendarStandardWeekdayTextSize/FONTS_COEFICIENT];
        _headerTitleFont = [UIFont fontWithName:FONTNAME size:FSCalendarStandardHeaderTextSize/FONTS_COEFICIENT];
        
        _headerTitleColor = FSCalendarStandardTitleTextColor;
        _headerDateFormat = @"MMMM yyyy";
        _headerMinimumDissolvedAlpha = 0;
...
- (void)setTitleFont:(UIFont *)titleFont
{
    if (![_titleFont isEqual:titleFont]) {
        _titleFont = [self getActualFont:titleFont];
...
- (void)setSubtitleFont:(UIFont *)subtitleFont
{
    if (![_subtitleFont isEqual:subtitleFont]) {
        _subtitleFont = [self getActualFont:subtitleFont];
...
- (void)setWeekdayFont:(UIFont *)weekdayFont
{
    if (![_weekdayFont isEqual:weekdayFont]) {
        _weekdayFont = [self getActualFont:weekdayFont];
        [self.calendar setNeedsConfigureAppearance];
    }
}
...
- (void)setHeaderTitleFont:(UIFont *)headerTitleFont
{
    if (![_headerTitleFont isEqual:headerTitleFont]) {
        _headerTitleFont = [self getActualFont:headerTitleFont];
        [self.calendar setNeedsConfigureAppearance];
    }
}

- (UIFont*) getActualFont: (UIFont*) font {
    NSString* fontName = font.fontName;
    return [UIFont fontWithName:fontName size:font.pointSize/FONTS_COEFICIENT];
}
...
{
    self.subtitleFont = [UIFont fontWithName:FONTNAME size:subtitleTextSize];
}
...
{
    self.headerTitleFont = [UIFont fontWithName:FONTNAME size:headerTitleTextSize];
}
