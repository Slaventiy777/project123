...
//        weekdayLabel.frame = CGRectMake(x, 0, width, self.contentView.fs_height);
        weekdayLabel.frame = CGRectMake(x, self.contentView.fs_height - weekdayLabel.font.lineHeight - 5, width, weekdayLabel.font.lineHeight);
        x += width;
    }];
    free(widths);
...
- (void)configureAppearance
{
    ...
    BOOL useDefaultWeekdayCase = NO;   //(self.calendar.appearance.caseOptions & (15<<4) ) == FSCalendarCaseOptionsWeekdayUsesDefaultCase;
